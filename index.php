    ...
    <nav class="navbar navbar-fixed-top navbar-inverse" role="navigation">
        <div class="container-fluid">
            <div class="navbar-header">
                <a class="navbar-brand" href="/update.txt">直播聚合(已适配移动端，需下载vlc播放器)</a>
        ...
        <div class="row">
            <div class="col-sm-2 sidebar">
                                <ul class="nav nav-sidebar">
                                    <li><a href="https://abbeyok.com/2018/09/23/pyone2-0/" target="_blank">搭建网盘</a></li>
									<?php
...
$url= "http://api.hclyz.cn:81/mf/".$url2;
$handle = fopen($url,"rb");
$content = "";
while (!feof($handle)) {
    $content .= fread($handle, 10000);
